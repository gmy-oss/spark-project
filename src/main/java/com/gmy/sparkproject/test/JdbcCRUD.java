...
//        delete();
    ...
    private static void insert(){
         ...
         * 3、创建SQL语句智行句柄：Connection。createStatement()
...
//        比如 insert update select delete语句
        ...
        try{
            ...
            conn = DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/spark-project",
                    "root","root"
            );
            ...
            String sql = "insert into test_user(name,age) values('张三',20)";

            int rtn = stmt.executeUpdate(sql);

            System.out.println("SQL语句影响了【"+rtn+"】");
        }catch (Exception e){
            e.printStackTrace();
        }finally {
    ...
    public static void update(){
        ...
        try {
            ...
            String sql = "update test_user set age = 23 where id = 1";
